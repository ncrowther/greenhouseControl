...
function GreenhouseLight() {
  ...
  if (light === 'ON') {
    lightButton = <div>
      <Button kind="primary" renderIcon={CiLight} inputid="light1" name="lightOn" value="ON" onClick={(e) => setLight('ON')} > ON*</Button>
    ...
    lightButton = <div>
      ...
      <Button kind="primary" renderIcon={CiLight} inputid="light2" name="lightOff" value="OFF" onClick={(e) => setLight('OFF')} > OFF*</Button>
      <Button kind="tertiary" renderIcon={CiLight} inputid="light3" name="lightAuto" value="AUTO" onClick={(e) => setLight('AUTO')}  > AUTO</Button>
    </div>
  }
  else {
    lightButton = <div>
      <Button kind="tertiary" renderIcon={CiLight} inputid="light1" name="lightOn" value="ON" onClick={(e) => setLight('ON')}> ON</Button>
      <Button kind="tertiary" renderIcon={CiLight} inputid="light2" name="lightOff" value="OFF" onClick={(e) => setLight('OFF')}> OFF</Button>
      <Button kind="primary" renderIcon={CiLight} inputid="light3" name="lightAuto" value="AUTO" onClick={(e) => setLight('AUTO')} > AUTO*</Button>
    </div>
