...
function GreenhouseDetails() {
  ...
  return (
    <Grid>
      <div>
        <Chip id="1" key="1" label={timeText} icon={MdOutlineAccessTime} /> 
        <Chip id="2" key="2" label={temperatureText} icon={FaTemperatureEmpty} /> 
        <Chip id="3" key="3" label={humidityText} icon={WiHumidity} /> 
        <Chip id="4" key="4" label={co2Text} icon={MdOutlineCo2} /> 
