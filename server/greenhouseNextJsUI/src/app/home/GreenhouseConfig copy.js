  ...
  return (
    ...
    <form onSubmit={(e) => handleOnSubmit(e)}>
      ...
      <div className="card flex flex-column md:flex-row gap-3">
        ...
        <h3>On:</h3>
        <Knob value={lightOnTime} onChange={(e) => setLightOnTime(e.value)} min={0} max={24} valueColor="orange" rangeColor="lightgray" />

        <h3>Off:</h3>
        <Knob value={lightOffTime} onChange={(e) => setLightOffTime(e.value)} min={0} max={24} valueColor="gray" rangeColor="lightgray" />
